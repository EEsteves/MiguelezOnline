...
Module CodeBase
        ...
        Function f4memoStr(ByRef fPtr As Integer) As String
                ...
                If MemoLen > &H7FFFFFFF Then
                        MsgBox("Error #: -910" & ControlChars.CrLf & "Unexpected Information" + r4line + "Memo entry too long to return in a Visual Basic string." + r4line + "Field Name:" + r4line + f4name(fPtr), 16, "CodeBase Error")
                        Exit Function
                End If
